...
if (isset($_POST['add'])) {
    ...
    $expensecategory = $_POST['textarea'];
    $balance = $_POST['balance'];
    $expenses = "INSERT INTO expenses (user_id, expense,expensedate,expensecategory, balance ) VALUES ('$userid', '$expenseamount','$expensedate','$expensecategory','$balance')";
...
if (isset($_POST['update'])) {
    ...
    $expensecategory = $_POST['textarea'];
    $balance = $_POST['balance'];
    $sql = "UPDATE expenses SET expense='$expenseamount', expensedate='$expensedate', expensecategory='$expensecategory', balance='$balance' WHERE user_id='$userid' AND expense_id='$id'";
                    ...
                    <div class="col-md" style="margin:0 auto;">
                        <form action="" method="POST">
                            <div class="form-group row">
                                <label for="expenseamount" class="col-sm-6 col-form-label"><b>Enter Amount(rupees)</b></label>
                                <div class="col-md-6">
                                    <input type="number" class="form-control col-sm-12" value="<?php echo $expenseamount; ?>" id="expenseamount" name="expenseamount">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="expenseamount" class="col-sm-6 col-form-label"><b>Enter Balance(rupees)</b></label>
                                <div class="col-md-6">
                                    <input type="number" class="form-control col-sm-12" value="<?php echo $edit_balance; ?>" id="expenseamount" name="balance">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <legend class="col-form-label col-sm-6 pt-0"><b>Description</b>
                                    <textarea name="textarea" id="" class="text" cols="30" rows="10" >
                                    <?php echo $expensecategory;?>
                              </textarea>
                                </legend>
                            </div>
