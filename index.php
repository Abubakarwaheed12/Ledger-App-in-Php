  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="border-right" id="sidebar-wrapper" >
      <div class="user">
        ...
        <img class="img img-fluid rounded-circle" src="<?php echo $userprofile ?>" width="70" height=50px">
          ...
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="img img-fluid rounded-circle" height="25px" src="<?php echo $userprofile ?>" width="25">
              </a>
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                <a class="dropdown-item ttttt" href="profile.php">Your Profile</a>
        ...
        <div class="row">
          <div class="col-md">
            <div class="card">
              ...
              <div class="card-body">           
                     <h3>Total expense is :  <?php 
                     $query=mysqli_query($con , "SELECT SUM(expense) as total
                     FROM expenses where user_id = '$userid'") or die("query failed");
          ...
          <div class="col-md">
            <div class="card">
              ...
              <div class="card-body">
                 <h3>Your Total Balance is : <?php 
                     $query=mysqli_query($con , "SELECT SUM(balance) -SUM(expense) as balance
                     FROM expenses where user_id = '$userid'") or die("query failed");
                     if(mysqli_num_rows($query)>=0){
                         $row=mysqli_fetch_assoc($query);
                         echo $row["balance"];
